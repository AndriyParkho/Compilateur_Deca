// Generated from /home/bastien/ensimag/Projet_GL/src/main/antlr4/fr/ensimag/deca/syntax/DecaParser.g4 by ANTLR 4.8
...
public class DecaParser extends AbstractDecaParser {
		...
		try {
			...
			if (_la==EQUALS) {
				...
				((Decl_varContext)_localctx).e = expr();
				            ...
				            setLocation(initialisation, (((Decl_varContext)_localctx).e!=null?(((Decl_varContext)_localctx).e.start):null));
				            ((Decl_varContext)_localctx).tree =  new DeclVar(t, ((Decl_varContext)_localctx).i.tree, initialisation);
				            estInitialise = true;
			...
			if (!(estInitialise=true)) {
			          ((Decl_varContext)_localctx).tree =  new DeclVar(t, ((Decl_varContext)_localctx).i.tree, noInit);
			      }
	...
	public final If_then_elseContext if_then_else() throws RecognitionException {
		...
		try {
			...
			match(CBRACE);
			        ...
			        ((If_then_elseContext)_localctx).tree = new IfThenElse(((If_then_elseContext)_localctx).condition.tree,((If_then_elseContext)_localctx).li_if.tree,currentList);
			        setLocation(_localctx.tree,((If_then_elseContext)_localctx).if1);
			        IfThenElse lastTree=_localctx.tree;
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					match(CBRACE);
					        ...
					        lastTree=new IfThenElse(((If_then_elseContext)_localctx).elsif_cond.tree,((If_then_elseContext)_localctx).elsif_li.tree,lastList);
					        setLocation(lastTree,((If_then_elseContext)_localctx).elsif);
	...
	public static final String _serializedATN =
		...
		"om\3\2\2\2op\3\2\2\2p\r\3\2\2\2qo\3\2\2\2rs\5\62\32\2sx\b\b\1\2tu\7\32"+
		...
		"\2\2\u00b7\u00b2\3\2\2\2\u00b8\23\3\2\2\2\u00b9\u00ba\7\b\2\2\u00ba\u00bb"+
		"\7\"\2\2\u00bb\u00bc\5\30\r\2\u00bc\u00bd\7#\2\2\u00bd\u00be\7$\2\2\u00be"+
		"\u00bf\5\20\t\2\u00bf\u00c0\7%\2\2\u00c0\u00cd\b\13\1\2\u00c1\u00c2\7"+
		"\6\2\2\u00c2\u00c3\7\b\2\2\u00c3\u00c4\7\"\2\2\u00c4\u00c5\5\30\r\2\u00c5"+
		...
		"\u00e8\u00ef\5\34\17\2\u00e9\u00ea\b\16\1\2\u00ea\u00eb\7\32\2\2\u00eb"+
		...
		"\1\2\u012d\u013e\3\2\2\2\u012e\u012f\f\5\2\2\u012f\u0130\7\31\2\2\u0130"+
		"\u0131\5$\23\2\u0131\u0132\b\22\1\2\u0132\u013e\3\2\2\2\u0133\u0134\f"+
		"\4\2\2\u0134\u0135\7\30\2\2\u0135\u0136\5$\23\2\u0136\u0137\b\22\1\2\u0137"+
		...
		"\7\33\2\2\u0148\u0149\5&\24\2\u0149\u014a\b\23\1\2\u014a\u0151\3\2\2\2"+
		"\u014b\u014c\f\3\2\2\u014c\u014d\7\34\2\2\u014d\u014e\5&\24\2\u014e\u014f"+
		...
		"\35\2\2\u015b\u015c\5(\25\2\u015c\u015d\b\24\1\2\u015d\u0169\3\2\2\2\u015e"+
		"\u015f\f\4\2\2\u015f\u0160\7\36\2\2\u0160\u0161\5(\25\2\u0161\u0162\b"+
		...
		"\u016d\u016e\7\34\2\2\u016e\u016f\5(\25\2\u016f\u0170\b\25\1\2\u0170\u0179"+
		...
		"\7\25\2\2\u01c2\u01ca\b\31\1\2\u01c3\u01c4\7\7\2\2\u01c4\u01ca\b\31\1"+
		...
		"\2\u0201\u0206\b\"\1\2\u0202\u0203\7\32\2\2\u0203\u0204\5\30\r\2\u0204"+
